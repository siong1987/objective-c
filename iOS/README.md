...
<<<<<<< HEAD
# PubNub 3.6.7 for iOS 5.1+ (iPhone, iPad, iPod)
=======
# PubNub 3.6.8 for iOS 5.1+ (iPhone, iPad, iPod)
>>>>>>> pt78591658
...
**DEPRECATED** Starting from **3.6.8** this set of methods has been deprecated:
```objc
