...
- (void)testMessageHistoryRequestForChannel {
    XCTAssertNotNil([PNMessageHistoryRequest messageHistoryRequestForChannel:nil from:nil to:nil limit:0 reverseHistory:NO], @"Cannot initialize PNMessageHistoryRequest");
}
